...
public class OperationInfo
{
   ...
   /**Lista de los parámetros formales y su respectivo tipo*/ 
   Map <String,String> parametros_tipo = new HashMap<String,String>();
   
   private String tipo_retorno = "void";
   private String nombre_OpRetorno = "";
   /**
    * Constructor
    */
   ...
   public void setOpRetorno(String nameOpRetorno){
	   nombre_OpRetorno=nameOpRetorno;
   }
   
   public void setParmsType(Map<String,String> parmtipos){
	   parametros_tipo = parmtipos;
   }
   /**
   ...
   public Map<String,String> getParmType()
   {
	   return parametros_tipo;
   }
   
   public String getNombreOpRetorno(){
	   return nombre_OpRetorno;
	   }
   }
