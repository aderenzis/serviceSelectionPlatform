...
//					adaptabilityGap -= 2;
			...
			//normalización de adaptabilityGap
...
//				//System.out.println("****************************************************************\n");
	...
	private Vector getLevelCompatibilidad(int returnCase, int nameCase, int paramCase, int excepCase) {
		...
		if (paramCase != 0 && returnCase != 0 && excepCase != 0 && nameCase != 0) {
			...
			// 54 Casos nuevos y automï¿½ticos, chequeados. R puede ser 1 ï¿½ 2.
			// N,
			// P, E pueden ser 1,2 ï¿½ 3.
	...
	private Vector getLevelCompatibilidadManual(int returnCase, int nameCase, int paramCase, int excepCase) {
		...
		if (paramCase != 0 && returnCase != 0 && excepCase != 0) {
			...
			// 54 Casos manuales, chequeados. R puede ser 1, 2 ï¿½ 3.
			// P puede ser 1,2,3 ï¿½ 4.
			// N, E pueden ser 1,2 ï¿½ 3.
	...
	// //Agreguï¿½ la divisiï¿½n por 2 en ï¿½ste punto y no en la
	// discretizaciï¿½n.
	//
	// }
	//
	...
	// Se incluyeron todas las conversiones sin pï¿½rdida de precision, segï¿½n
	// nueva def. R2
	...
	// [S --> array de short
	// [I --> array de int
	// [J --> array de long, prestar atencion! es J y no L como uno supondrï¿½a!
	// [F --> array de float
	// [D --> array de double
	...
	/**
	 * -----------------------------------------------------------------
	 * Ordenamiento en O(n). Se usa cuando las claves de bï¿½squeda estï¿½n
	 * dentro de un rango determinado (finito y conocido). Algoritmo:
	 * enumeraciï¿½n por Distribuciï¿½n
	 */
	...
	public Vector getSortedVector(Vector a, int rango) {
		...
		for (int i = 1; i < rango; i++) {
			// calcula la posicion mï¿½s a la derecha de una clave.+1
	...
	public double getAdaptabilityGap() {
		...
		for (Operation m : operations) {
			...
			// //System.out.println("CompatiblÃ±es: "+compatibles.size());
			minAdapMeth = 3;
